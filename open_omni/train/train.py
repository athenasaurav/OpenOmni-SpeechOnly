...
from open_omni.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX
from open_omni.constants import SPEECH_TOKEN_INDEX, DEFAULT_SPEECH_TOKEN
from open_omni.train.llava_trainer import LLaVATrainer

from open_omni import conversation as conversation_lib
from open_omni.model import *
from open_omni.mm_utils import process_highres_image, process_anyres_image, process_highres_image_crop_split, tokenizer_image_token, merge_duplicates
from open_omni.utils import rank0_print, process_video_with_pyav, process_audio_with_whisper
    ...
    for i, source in enumerate(sources):
        ...
        for j, sentence in enumerate(source):
            ...
            if has_units and "tgt_units" in sentence:
                ...
                # # deduplication
                # tgt_unit, duration_list = merge_duplicates(tgt_unit)
